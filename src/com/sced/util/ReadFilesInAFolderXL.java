 ...
 *
 */
public class ReadFilesInAFolderXL {
	...
	public ReadFilesInAFolderXL(String path, boolean isAbsPath)
	{
	...
	public String[] getFileNamesLowerCase()
	{
		String[] fileNames = new String[_fileList.length];
		for (int i=0; i<_fileList.length; i++)
			fileNames[i] = getFileName(i).toLowerCase();
		return fileNames;		
	}
